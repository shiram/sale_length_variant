...
class SaleOrderLine(models.Model):
    ...
    length = fields.Float(string='Length', digits=(3,2))
...
class AccountMoveLine(models.Model):
    ...
    def _get_price_total_and_subtotal(self, price_unit=None, quantity=None, discount=None, currency=None, product=None, partner=None, taxes=None, move_type=None):
        ...
        return self._get_price_total_and_subtotal_model(
            ...
            quantity=((quantity if quantity else 0) * (self.length if (self.length and self.length > 0) else 1)) or (self.quantity * (self.length if (self.length and self.length > 0) else 1)),
            ...
            if move.is_invoice(include_receipts=True):
                ...
                if any(vals.get(field) for field in ACCOUNTING_FIELDS):
                    price_subtotal = self._get_price_total_and_subtotal_model(
                        ...
                        (vals.get('quantity', 0.0) * (vals.get('length', 0.0) if vals.get('length', 0.0) > 0 else 1)),
